...
AES_CTR_xcrypt_buffe::AES_CTR_xcrypt_buffe(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_7_fu_397_p2);
    sensitive << ( i_0_i3_reg_214 );

    SC_METHOD(thread_i_8_fu_274_p2);
    ...
    sc_trace(mVcdFile, i_8_fu_274_p2, "i_8_fu_274_p2");
    sc_trace(mVcdFile, i_8_reg_516, "i_8_reg_516");
    ...
    sc_trace(mVcdFile, i_6_reg_551, "i_6_reg_551");
    ...
    sc_trace(mVcdFile, i_7_fu_397_p2, "i_7_fu_397_p2");
    sc_trace(mVcdFile, i_7_reg_587, "i_7_reg_587");
...
void AES_CTR_xcrypt_buffe::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(icmp_ln575_reg_521.read(), ap_const_lv1_0)))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_6_reg_551 = i_6_fu_321_p2.read();
        zext_ln483_reg_543 = zext_ln483_fu_311_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        i_7_reg_587 = i_7_fu_397_p2.read();
        zext_ln491_reg_579 = zext_ln491_fu_387_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_8_reg_516 = i_8_fu_274_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void AES_CTR_xcrypt_buffe::thread_i_6_fu_321_p2() {
    i_6_fu_321_p2 = (!i_0_i2_reg_192.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(i_0_i2_reg_192.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void AES_CTR_xcrypt_buffe::thread_i_7_fu_397_p2() {
    i_7_fu_397_p2 = (!i_0_i3_reg_214.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(i_0_i3_reg_214.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void AES_CTR_xcrypt_buffe::thread_i_8_fu_274_p2() {
    i_8_fu_274_p2 = (!i_0_reg_157.read().is_01() || !ap_const_lv5_1.is_01())? sc_lv<5>(): (sc_biguint<5>(i_0_reg_157.read()) + sc_biguint<5>(ap_const_lv5_1));
}
