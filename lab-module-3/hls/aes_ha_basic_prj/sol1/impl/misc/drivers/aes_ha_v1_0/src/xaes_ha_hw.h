...
#define XAES_HA_SLV_ADDR_INOUT_R_BASE 0x30
#define XAES_HA_SLV_ADDR_INOUT_R_HIGH 0x3f
#define XAES_HA_SLV_WIDTH_INOUT_R     8
#define XAES_HA_SLV_DEPTH_INOUT_R     16
