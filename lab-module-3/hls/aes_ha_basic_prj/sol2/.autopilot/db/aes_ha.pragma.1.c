# 1 "hls/basic/aes_ha.c"
# 1 "hls/basic/aes_ha.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "hls/basic/aes_ha.c" 2
# 1 "hls/basic/../../c_src/aes.h" 1
# 10 "hls/basic/../../c_src/aes.h"
...
# 11 "hls/basic/../../c_src/aes.h" 2
# 50 "hls/basic/../../c_src/aes.h"
struct AES_ctx {
...
# 79 "hls/basic/../../c_src/aes.h"
void AES_CBC_encrypt_buffer(struct AES_ctx *ctx, uint8_t *buf, uint32_t length);
void AES_CBC_decrypt_buffer(struct AES_ctx *ctx, uint8_t *buf, uint32_t length);
# 92 "hls/basic/../../c_src/aes.h"
void AES_CTR_xcrypt_buffer(struct AES_ctx *ctx, uint8_t *buf, uint32_t length);
# 2 "hls/basic/aes_ha.c" 2
# 1 "hls/basic/aes_ha.h" 1
...
# 3 "hls/basic/aes_ha.c" 2

void aes_ha(uint8_t key[16], uint8_t iv[16], uint8_t inout[16])
{_ssdm_SpecArrayDimSize(key, 16);_ssdm_SpecArrayDimSize(iv, 16);_ssdm_SpecArrayDimSize(inout, 16);
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 5 "hls/basic/aes_ha.c"

_ssdm_op_SpecInterface(inout, "s_axilite", 1, 1, "", 0, 0, "slv", "", "", 0, 0, 0, 0, "", "");
