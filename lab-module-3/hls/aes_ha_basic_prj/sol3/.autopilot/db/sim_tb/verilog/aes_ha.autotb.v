...
`define AUTOTB_TVOUT_inout_r  "./c.aes_ha.autotvout_inout_r.dat"
`define AUTOTB_TVOUT_iv_out_wrapc  "./impl_rtl.aes_ha.autotvout_iv.dat"
`define AUTOTB_TVOUT_inout_r_out_wrapc  "./impl_rtl.aes_ha.autotvout_inout_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1104;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 207;
parameter LENGTH_key = 16;
parameter LENGTH_iv = 16;
parameter LENGTH_inout_r = 16;
...
reg end_inout_r;
reg [31:0] size_inout_r;
reg [31:0] size_inout_r_backup;
...
reg dump_tvout_finish_inout_r;

initial begin : dump_tvout_runtime_sign_inout_r
    integer fp;
    dump_tvout_finish_inout_r = 0;
    fp = $fopen(`AUTOTB_TVOUT_inout_r_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_inout_r_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_inout_r_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_inout_r_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
