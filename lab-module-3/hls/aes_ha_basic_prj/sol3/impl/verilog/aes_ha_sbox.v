...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module aes_ha_sbox_rom (
...
initial begin
    $readmemh("./aes_ha_sbox_rom.dat", ram0);
    $readmemh("./aes_ha_sbox_rom.dat", ram1);
    $readmemh("./aes_ha_sbox_rom.dat", ram2);
    $readmemh("./aes_ha_sbox_rom.dat", ram3);
    $readmemh("./aes_ha_sbox_rom.dat", ram4);
    $readmemh("./aes_ha_sbox_rom.dat", ram5);
    $readmemh("./aes_ha_sbox_rom.dat", ram6);
    $readmemh("./aes_ha_sbox_rom.dat", ram7);
end
...
aes_ha_sbox_rom aes_ha_sbox_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
