...
initial begin
    $readmemh("./AES_CTR_xcrypt_buffe_sbox_rom.dat", ram0);
    $readmemh("./AES_CTR_xcrypt_buffe_sbox_rom.dat", ram1);
    $readmemh("./AES_CTR_xcrypt_buffe_sbox_rom.dat", ram2);
    $readmemh("./AES_CTR_xcrypt_buffe_sbox_rom.dat", ram3);
    $readmemh("./AES_CTR_xcrypt_buffe_sbox_rom.dat", ram4);
    $readmemh("./AES_CTR_xcrypt_buffe_sbox_rom.dat", ram5);
    $readmemh("./AES_CTR_xcrypt_buffe_sbox_rom.dat", ram6);
    $readmemh("./AES_CTR_xcrypt_buffe_sbox_rom.dat", ram7);
end
