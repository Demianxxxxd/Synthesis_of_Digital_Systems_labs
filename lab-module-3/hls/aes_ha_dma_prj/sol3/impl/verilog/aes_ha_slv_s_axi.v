...
localparam
    ...
    ADDR_IER             = 7'h08,
    ADDR_ISR             = 7'h0c,
    ADDR_IN_R_DATA_0     = 7'h30,
    ADDR_IN_R_CTRL       = 7'h34,
    ADDR_OUT_R_DATA_0    = 7'h38,
    ADDR_OUT_R_CTRL      = 7'h3c,
    ADDR_LENGTH_R_DATA_0 = 7'h40,
    ADDR_LENGTH_R_CTRL   = 7'h44,
    ADDR_KEY_BASE        = 7'h10,
    ADDR_KEY_HIGH        = 7'h1f,
    ADDR_IV_BASE         = 7'h20,
    ADDR_IV_HIGH         = 7'h2f,
...
assign RVALID  = (rstate == RDDATA) & !int_key_read & !int_iv_read;
