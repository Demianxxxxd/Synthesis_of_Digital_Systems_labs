...
// ==============================================================
#ifndef __AES_CTR_xcrypt_buffe_sbox_H__
#define __AES_CTR_xcrypt_buffe_sbox_H__
...
struct AES_CTR_xcrypt_buffe_sbox_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(AES_CTR_xcrypt_buffe_sbox_ram) {
        ram[0] = "0b01100011";
        ram[1] = "0b01111100";
        ram[2] = "0b01110111";
        ram[3] = "0b01111011";
...
SC_MODULE(AES_CTR_xcrypt_buffe_sbox) {
...
AES_CTR_xcrypt_buffe_sbox_ram* meminst;


SC_CTOR(AES_CTR_xcrypt_buffe_sbox) {
meminst = new AES_CTR_xcrypt_buffe_sbox_ram("AES_CTR_xcrypt_buffe_sbox_ram");
