...
architecture behav of AES_CTR_xcrypt_buffe is 
    ...
    signal i_9_fu_274_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_9_reg_516 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i_7_fu_321_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_7_reg_551 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal i_8_fu_397_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_8_reg_587 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    i_7_fu_321_p2 <= std_logic_vector(unsigned(i_0_i2_reg_192) + unsigned(ap_const_lv3_1));
    i_8_fu_397_p2 <= std_logic_vector(unsigned(i_0_i3_reg_214) + unsigned(ap_const_lv3_1));
    i_9_fu_274_p2 <= std_logic_vector(unsigned(i_0_reg_157) + unsigned(ap_const_lv5_1));
