...
void XAes_ha_Set_in_r(XAes_ha *InstancePtr, u32 Data) {
    ...
    XAes_ha_WriteReg(InstancePtr->Slv_BaseAddress, XAES_HA_SLV_ADDR_IN_R_DATA, Data);
}
...
u32 XAes_ha_Get_in_r(XAes_ha *InstancePtr) {
    ...
    Data = XAes_ha_ReadReg(InstancePtr->Slv_BaseAddress, XAES_HA_SLV_ADDR_IN_R_DATA);
    return Data;
}
...
void XAes_ha_Set_out_r(XAes_ha *InstancePtr, u32 Data) {
    ...
    XAes_ha_WriteReg(InstancePtr->Slv_BaseAddress, XAES_HA_SLV_ADDR_OUT_R_DATA, Data);
}
...
u32 XAes_ha_Get_out_r(XAes_ha *InstancePtr) {
    ...
    Data = XAes_ha_ReadReg(InstancePtr->Slv_BaseAddress, XAES_HA_SLV_ADDR_OUT_R_DATA);
    return Data;
}
...
void XAes_ha_Set_length_r(XAes_ha *InstancePtr, u32 Data) {
    ...
    XAes_ha_WriteReg(InstancePtr->Slv_BaseAddress, XAES_HA_SLV_ADDR_LENGTH_R_DATA, Data);
}
...
u32 XAes_ha_Get_length_r(XAes_ha *InstancePtr) {
    ...
    Data = XAes_ha_ReadReg(InstancePtr->Slv_BaseAddress, XAES_HA_SLV_ADDR_LENGTH_R_DATA);
    return Data;
}
