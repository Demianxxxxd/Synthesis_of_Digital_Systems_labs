...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "hls/dma/aes_ha.c" 2
# 1 "hls/dma/aes_ha.h" 1
...
# 5 "hls/dma/aes_ha.h" 2



void aes_ha(uint8_t key[16], uint8_t iv[16], uint8_t* in, uint8_t* out, int length);
# 2 "hls/dma/aes_ha.c" 2
# 1 "hls/dma/../../c_src/aes.h" 1
# 50 "hls/dma/../../c_src/aes.h"
struct AES_ctx {
...
# 79 "hls/dma/../../c_src/aes.h"
void AES_CBC_encrypt_buffer(struct AES_ctx *ctx, uint8_t *buf, uint32_t length);
void AES_CBC_decrypt_buffer(struct AES_ctx *ctx, uint8_t *buf, uint32_t length);
# 92 "hls/dma/../../c_src/aes.h"
void AES_CTR_xcrypt_buffer(struct AES_ctx *ctx, uint8_t *buf, uint32_t length);
# 3 "hls/dma/aes_ha.c" 2

extern void _memcpy(uint8_t * dst, const uint8_t* src, unsigned int num);

void aes_ha(uint8_t key[16], uint8_t iv[16], uint8_t* in, uint8_t* out, int length)
{_ssdm_SpecArrayDimSize(key, 16);_ssdm_SpecArrayDimSize(iv, 16);
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 7 "hls/dma/aes_ha.c"

_ssdm_op_SpecInterface(out, "m_axi", 0, 0, "", 0, 8832, "mst", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(in, "m_axi", 0, 0, "", 0, 8832, "mst", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(length, "s_axilite", 1, 1, "", 0, 0, "slv", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(iv, "s_axilite", 1, 1, "", 0, 0, "slv", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(key, "s_axilite", 1, 1, "", 0, 0, "slv", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(0, "s_axilite", 1, 1, "", 0, 0, "slv", "", "", 0, 0, 0, 0, "", "");
